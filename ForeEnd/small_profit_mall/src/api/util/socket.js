...
export const initWebSocket = () => { //初始化websocket
  ...
  // const wsUri = (window.location.protocol == 'http:')
  //     ? "ws://localhost:3167/notification/" + sessionStorage.getItem("uId")
  //     : "wss://localhost:3167/notification/" + sessionStorage.getItem("uId");
...
function startHeartbeat() {
  ...
  const heartbeatPacket = {
    ...
    code: "81000",
    message: "Confirm heartbeat link"
  };
