...
//到货通知
export const arrivalNotice=(userId,productId,distinctionId)=>{
  return http.requestPost(apiUrl+'/ShoppingCartController/addArrivalNotice/'+userId+'/'+productId+'/'+distinctionId)
};
//修改购物车商品数量
